...
using Kulagin.Mastering_WPF.Managers.Interfaces;
using MessageBoxButton =
    Kulagin.Mastering_WPF.DataModels.Enums.MessageBoxButton;
using MessageBoxButtonSelection =
    Kulagin.Mastering_WPF.DataModels.Enums.MessageBoxButtonSelection;
using MessageBoxIcon =
    Kulagin.Mastering_WPF.DataModels.Enums.MessageBoxIcon;
        ...
        public MessageBoxButtonSelection ShowMessageBox(string message, string title, MessageBoxButton buttons, MessageBoxIcon icon) {
            ...
            switch (buttons) {
                ...
                case MessageBoxButton.YesNoCancel:
                    messageBoxButtons = System.Windows.MessageBoxButton.YesNoCancel;
                    break;
                default:
                    messageBoxButtons = System.Windows.MessageBoxButton.OKCancel;
                    break;
            ...
            switch (MessageBox.Show(message, title, messageBoxButtons, messageBoxImage)) {
                case MessageBoxResult.Cancel:
                    messageBoxButtonSelection = MessageBoxButtonSelection.Cancel;
                    break;
                case MessageBoxResult.No:
                    messageBoxButtonSelection = MessageBoxButtonSelection.No;
                    break;
                case MessageBoxResult.OK:
                    messageBoxButtonSelection = MessageBoxButtonSelection.Ok;
                    break;
                case MessageBoxResult.Yes:
                    messageBoxButtonSelection = MessageBoxButtonSelection.Yes;
                    break;
